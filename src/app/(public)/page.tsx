        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              {
                name: "Моника Петрова",
                text: "Останах одивена от релефа на плочите, които поръчах за моя дом. Лесни за монтаж и с изключителен външен вид.",
                rating: 5,
              },
              {
                name: "Мария Георгиева",
                text: "Поръчах гипсови орнаменти за дневната и останах изключително доволна. Прецизна изработка и бърза доставка.",
                rating: 5,
              },
              {
                name: "Стоян Димитров",
                text: "Използвах облицовката за акцентна стена – резултатът е страхотен. Определено ще поръчам отново!",
                rating: 5,
              },
