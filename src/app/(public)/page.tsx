        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Гипсови изделия за дом и индустрия – качество, занаятчийство и перфекция
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Ние сме специализирани в производството на висококачествени гипсови изделия 
              за декорация и строителна промишленост. С години опит и внимание към детайла, 
              предлагаме продукти, които съчетават естетика, функционалност и издръжливост.
            </p>
          </div>
        </div>
      </section>
